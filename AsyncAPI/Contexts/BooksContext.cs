    ...
    public class BooksContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Author>().HasData(
                new Author()
                {
                    Id = 1, // Guid.Parse("d28888e9-2ba9-473a-a40f-e38cb54f9b35"),
                    FirstName = "George",
                    LastName = "RR Martin"
                },
                new Author()
                {
                    Id = 2, //Guid.Parse("da2fd609-d754-4feb-8acd-c4f9ff13ba96"),
                    FirstName = "Stephen",
                    LastName = "Fry"
                },
                new Author()
                {
                    Id = 3, //Guid.Parse("24810dfc-2d94-4cc7-aab5-cdf98b83f0c9"),
                    FirstName = "James",
                    LastName = "Elroy"
                },
                new Author()
                {
                    Id = 4, //Guid.Parse("2902b665-1190-4c70-9915-b9c2d7680450"),
                    FirstName = "Douglas",
                    LastName = "Adams"
                }
            );
            ...
            modelBuilder.Entity<Book>().HasData(
                new Book
                {
                    Id = 1, //Guid.Parse("5b1c2b4d-48c7-402a-80c3-cc796ad49c6b"),
                    AuthorId = 1, //Guid.Parse("d28888e9-2ba9-473a-a40f-e38cb54f9b35"),
                    Title = "The Winds of Winter",
                    Description = "The book that seems impossible to write."
                },
                new Book
                {
                    Id = 2, //Guid.Parse("d8663e5e-7494-4f81-8739-6e0de1bea7ee"),
                    AuthorId = 1, //Guid.Parse("d28888e9-2ba9-473a-a40f-e38cb54f9b35"),
                ...
                new Book
                {
                    Id = 3, //Guid.Parse("d173e20d-159e-4127-9ce9-b0ac2564ad97"),
                    AuthorId = 2, //Guid.Parse("da2fd609-d754-4feb-8acd-c4f9ff13ba96"),
                    Title = "Mythos",
                    Description =
                ...
                new Book
                {
                    Id = 4, //Guid.Parse("493c3228-3444-4a49-9cc0-e8532edc59b2"),
                    AuthorId = 3, //Guid.Parse("24810dfc-2d94-4cc7-aab5-cdf98b83f0c9"),
                ...
                new Book
                {
                    Id = 5, //Guid.Parse("40ff5488-fdab-45b5-bc3a-14302d59869a"),
                    AuthorId = 4, //Guid.Parse("2902b665-1190-4c70-9915-b9c2d7680450"),
